# generate matrix factorization data from pre-computed ctr file
# user_id doc_id ctr
# user_id is mapped to local id start from 0, so are doc_id
# output:
# mf training data; user_id_map, doc_id_map
# python program ctr_data user_freq_file user_freq_threshold output_training_data user_id_map_file doc_id_map_file
