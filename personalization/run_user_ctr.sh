num_cluster=5
python do_user_clustering_step1.py ../temp_data/ydata-fp-td-clicks-v1_0.20090501.user_cluster_using_ctr_as_fea ${num_cluster} ../temp_data/user_ctr_clustering
python do_user_clustering_step2.py ../temp_data/user_ctr_clustering ../temp_data/ydata-fp-td-clicks-v1_0.20090501.user_cluster_using_ctr_as_fea ../temp_data/user_ctr_results
